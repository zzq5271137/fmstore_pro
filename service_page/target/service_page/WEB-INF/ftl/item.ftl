...
<script>
    let skuList = [
        <#list itemList as item>
        {
            ...
            title: '${item.title}',
            price: ${item.price?c},
            spec: ${item.spec}  <#-- 这里没有使用''去赋值, 所以它会自动的将json字符串转成对象 -->
        },
        </#list>
    ];
</script>
                        ...
                        <div class="summary-wrap">
                            ...
                            <div class="fr remark">
                                <div id="comment-count" class="comment-count item fl"
                                    ...
                                    <p class="comment" style="margin-bottom: 0px;font-size: 14px;">
                                        累计评价</p>
                        ...
                        <div class="summary-wrap">
                            ...
                            <div class="fl fix-width">
                                <i class="goods-icons4 J-picon-tips"
                                   style="margin-top: 6px; margin-right: 7px;">满送活动</i>
                        ...
                        <div id="specification" class="summary-wrap clearfix">
                            <#list specificationList as spec>
                                <dl>
                                    ...
                                    <#list spec.options as item>
                                        <dd>
                                            <a href="javascript:;"
                                               :class="isSelected('${spec.spec_name}', '${item}') ? 'selected' : ''"
                                               @click="selectSpecification('${spec.spec_name}', '${item}')"
                                            >
                        ...
                        <div class="summary-wrap">
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        <input autocomplete="off" type="text" v-model="num"
                                               minnum="1"
                                               class="itxt"/>
                            ...
                            <div class="fl">
                                <ul class="btn-choose unstyled">
                                    <li>
                                        <a class="sui-btn  btn-danger addshopcar"
...
<script type="text/template" id="tbar-cart-item-template">
    <div class="tbar-cart-item">
        ...
        <div class="jtc-item-goods">
            <span class="p-img">
				<a href="#" target="_blank"><img src="{2}" alt="{1}" height="50" width="50"/></a>
			</span>
            <div class="p-name">
                <a href="#">{1}</a>
            </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            isSelected: function (key, value) {
                return this.specificationItems[key] === value;
            },
            ...
            addToCart: function () {
                axios.get("http://localhost:8084/cart/addGoodsToCartList.do",
                    {params: {itemId: this.sku.id, num: this.num}}).then(function (response) {
